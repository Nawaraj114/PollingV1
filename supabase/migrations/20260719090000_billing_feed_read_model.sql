...
revoke all on function public.get_bill_feed() from public;
grant execute on function public.get_bill_feed() to authenticated;

comment on function public.get_bill_feed() is
  'Returns the signed-in member billing feed in one RLS-protected database round trip; settled bills are excluded.';
